...
import type { AuthResponse, LoginRequest, RegisterParentRequest, RegisterStudentRequest, RegisterTeacherRequest } from '../types'
...
export const authApi = {
  ...
  registerStudent: (data: RegisterStudentRequest) =>
    client.post<AuthResponse>('/auth/register-student', data).then((r) => r.data),
