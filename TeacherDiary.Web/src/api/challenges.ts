...
import type { ChallengeCreateRequest, ChallengeDto, ChallengeStudentProgressDto } from '../types'
...
export const challengesApi = {
  ...
  getStudentProgress: (classId: string, challengeId: string) =>
    client.get<ChallengeStudentProgressDto[]>(`/classes/${classId}/challenges/${challengeId}/student-progress`).then((r) => r.data),
}
