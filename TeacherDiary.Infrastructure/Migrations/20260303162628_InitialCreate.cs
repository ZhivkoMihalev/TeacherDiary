    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignedBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignedBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssignedBooks_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Challenges_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityLogs_Students_StudentProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentProgress_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AssignmentProgress_Students_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChallengeProgress_Students_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignedBookId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingProgress_AssignedBooks_AssignedBookId",
                        column: x => x.AssignedBookId,
                        principalTable: "AssignedBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReadingProgress_Students_StudentProfileId",
                        column: x => x.StudentProfileId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_StudentProfileId_Date",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignedBooks_BookId",
                table: "AssignedBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignedBooks_ClassId",
                table: "AssignedBooks",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentProgress_AssignmentId",
                table: "AssignmentProgress",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentProgress_StudentProfileId_AssignmentId",
                table: "AssignmentProgress",
                columns: new[] { "StudentProfileId", "AssignmentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeProgress_StudentProfileId",
                table: "ChallengeProgress",
                column: "StudentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Challenges_ClassId",
                table: "Challenges",
                column: "ClassId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgress_AssignedBookId",
                table: "ReadingProgress",
                column: "AssignedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgress_StudentProfileId_AssignedBookId",
                table: "ReadingProgress",
                columns: new[] { "StudentProfileId", "AssignedBookId" },
                unique: true);
