...
public sealed class AssignmentCreatedNotificationHandler(
    AppDbContext db,
    INotificationService notificationService) : IDomainEventHandler<AssignmentCreatedEvent>
{
    public async Task HandleAsync(AssignmentCreatedEvent e, CancellationToken cancellationToken)
    {
